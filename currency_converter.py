...
class CurrencyConverter:
    def __init__(self, root):
        ...
        self.button_usd = tk.Button(root, text="USDollar ", command=lambda: self.convert("USD"))
        self.button_usd.pack(pady=5)

        self.button_yen = tk.Button(root, text="JYen", command=lambda: self.convert("JPY"))
        self.button_yen.pack(pady=5)

        self.button_sek = tk.Button(root, text="SKrone", command=lambda: self.convert("SEK"))
